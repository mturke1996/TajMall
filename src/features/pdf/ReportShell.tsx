// @ts-nocheck — react-pdf JSX styles; runtime-validated via report exports
import React from 'react';
import { Document, Page, Text, View } from '@react-pdf/renderer';
import { ar, arDateParts } from './arabicPDF';
import { pdfBase, PDF, PDF_PAGINATION } from './pdfBase';
import { TajMallPdfFooter, TajMallPdfHeader, PdfReportHeaderFlow, PdfMoneyText } from './pdfBrandKit';
